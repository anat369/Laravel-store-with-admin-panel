...
if (gfx('#google-map-footer').length>0) {
	var e=new google.maps.LatLng(55.700471, 37.658407),
		o={zoom:17,center:new google.maps.LatLng(55.700471, 37.658407),
		...
		var g='<div class="map-marker"><h4 class="color-dark xbold">MAHDI</h4><p>Россия, город Москва</p><p>ул. Лобанова, 8, Москва, 115432</p></div>',a=new google.maps.InfoWindow({content:g})
		,t=new google.maps.MarkerImage("/images/marker.png",new google.maps.Size(50,50),
		new google.maps.Point(0,0),new google.maps.Point(75,50)),
		i=new google.maps.LatLng(55.700329, 37.658491),
...
if (gfx('#google-map').length>0) {
	...
	var e=new google.maps.LatLng(55.700471, 37.658407),
		...
		,t=new google.maps.MarkerImage("/images/marker.png",new google.maps.Size(157,70),
		new google.maps.Point(0,0),new google.maps.Point(75,50)),
		i=new google.maps.LatLng(55.700471, 37.658407),
		p=new google.maps.Marker({position:i,map:n,icon:t,zIndex:3});
		google.maps.event.addListener(p,"click",function(){a.open(n,p)}),
...
gfx(function() {
    var endDate = "May 12, 2020 09:03:25";
